...
USER_ID="namespace-12345-67890-abcdef-admin"
RESOURCE_ID="namespace-12345-67890-abcdef"
RELATIONS_PORT=9000
...
MESSAGE="{\"tuples\":[
  ...
  {\"resource\":{\"id\":\"${RESOURCE_ID}\",\"type\":{\"name\":\"k8s_namespace\",\"namespace\":\"acm\"}},\"relation\":\"user_grant\",\"subject\":{\"subject\":{\"id\":\"${BINDING_ID}\",\"type\":{\"name\":\"role_binding\",\"namespace\":\"rbac\"}}}}
]}"
